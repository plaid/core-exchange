...
<ul style={{listStyleType:"none"}}>
  ...
  <li><input type="checkbox"/>  **Does your organization already have access to the Plaid Dashboard?**</li>
  <ul style={{listStyleType:"inherit"}}>
    <li><input type="checkbox"/>  **If yes:** Navigate to the top left to create a new team for accessing Plaid’s Core Exchange features</li>
    <li><input type="checkbox"/>  **If no:** Create an account on the <a href="https://dashboard.plaid.com/">Plaid dashboard</a> as a Data Partner and follow steps to access Plaid’s Core Exchange features</li>
  </ul>
...
If your institution is already supported in [Plaid Link](https://plaid.github.io/core-exchange/user-experience) or you are a [platform provider](#platform-providers) with numerous institutions, we will partner together to develop a pilot and migration plan.
...
<ul style={{listStyleType:"none"}}>
  ...
  <ul style={{listStyleType:"inherit"}}>
    <li><input type="checkbox"/>  OAuth flow: log `oauth_state_id`</li>
    <li><input type="checkbox"/>  API connections: log `FI_UNIQUE_ID`</li>
  </ul>
...
<h2 id="platform-providers">Key considerations for Digital Banking Platforms</h2>
