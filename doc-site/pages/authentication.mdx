...
If you don't yet have an identity provider for integrating with OAuth, Plaid recommends Okta, 
an industry leading independent identity provider with expertise onboarding data partners to OAuth integrations. 
To learn more, see the [blog post about Plaid's partnership with Okta](https://www.okta.com/blog/2023/02/how-oktas-new-plaid-integration-keeps-your-banking-secure/) 
or contact dataconnectivity@plaid.com to get started with Okta for your Data Connectivity integration.
